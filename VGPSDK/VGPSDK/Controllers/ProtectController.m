...
@interface ProtectController () {
    ...
    UIView *rightPanel;
    UILabel *rightPanalProtectAccountLabel;
...
- (void)viewDidLoad {
    ...
    rightPanalProtectAccountLabel = [[UILabel alloc] init];
    rightPanalProtectAccountLabel.text = [VGPHelper localizationForString:@"profile.protect.text"];
    rightPanalProtectAccountLabel.textColor = VGP_MAIN_TEXT_COLOR;
    rightPanalProtectAccountLabel.font = [UIFont fontWithName:@"LexendDeca-Regular" size:20];
    rightPanalProtectAccountLabel.numberOfLines = 0;
    rightPanalProtectAccountLabel.textAlignment = NSTextAlignmentCenter;
    [rightPanel addSubview:rightPanalProtectAccountLabel];
    
    rightPanalProtectAccountLabel.translatesAutoresizingMaskIntoConstraints = NO;
    [[rightPanalProtectAccountLabel.topAnchor constraintEqualToAnchor:leftPanelImage.topAnchor constant:0] setActive:YES];
    [[rightPanalProtectAccountLabel.leftAnchor constraintEqualToAnchor:rightPanel.leftAnchor] setActive:YES];
    [[rightPanalProtectAccountLabel.widthAnchor constraintEqualToAnchor:rightPanel.widthAnchor multiplier:.8] setActive:YES];
    [[rightPanalProtectAccountLabel.heightAnchor constraintEqualToConstant:width*.15] setActive:YES];
    [rightPanalProtectAccountLabel setContentCompressionResistancePriority:UILayoutPriorityRequired forAxis:UILayoutConstraintAxisVertical];
    ...
    [[rightPanelProtectPhoneButton.centerXAnchor constraintEqualToAnchor:rightPanalProtectAccountLabel.centerXAnchor] setActive:YES];
    [[rightPanelProtectPhoneButton.topAnchor constraintEqualToAnchor:rightPanalProtectAccountLabel.bottomAnchor constant:width*0.02] setActive:YES];
    [[rightPanelProtectPhoneButton.widthAnchor constraintEqualToAnchor:rightPanalProtectAccountLabel.widthAnchor multiplier:1] setActive:YES];
